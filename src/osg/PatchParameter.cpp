...
#else
		extensions->_glPatchParameteri( GL_PATCH_VERTICES, _vertices );
        extensions->_glPatchParameterfv( GL_PATCH_DEFAULT_INNER_LEVEL, _patchDefaultInnerLevel.ptr() );
        extensions->_glPatchParameterfv( GL_PATCH_DEFAULT_OUTER_LEVEL, _patchDefaultOuterLevel.ptr() );
#endif
    }
}
