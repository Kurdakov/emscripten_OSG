...
#else
		_extensions->_glGenBuffers(1, &_glObjectID);
#endif
    }
...
#else
	_extensions->_glBindBuffer(_profile._target, _glObjectID);
#endif
...
#else
		_extensions->_glBufferData(_profile._target, _profile._size, NULL, _profile._usage);
#endif
        ...
        if (entry.dataSource && (compileAll || entry.modifiedCount != entry.dataSource->getModifiedCount()))
        {
            ...
            if (image && !(image->isDataContiguous()))
            {
                ...
                for(osg::Image::DataIterator img_itr(image); img_itr.valid(); ++img_itr)
                {
					...
					#else
						_extensions->_glBufferSubData(_profile._target, (GLintptrARB)offset, (GLsizeiptrARB)img_itr.size(), img_itr.data());
					#endif
                    offset += img_itr.size();
                }
            }
            else
            {
				...
				#else
						_extensions->_glBufferSubData(_profile._target, (GLintptrARB)entry.offset, (GLsizeiptrARB)entry.dataSize, entry.dataSource->getDataPointer());
				#endif           
            }
        }
    }
...
void GLBufferObject::deleteGLObject()
{
	...
	#else
		    _extensions->_glDeleteBuffers(1, &_glObjectID);
	#endif   
		_glObjectID = 0;
...
//    glIsBuffer = rhs.glIsBuffer;
//    glGetBufferSubData = rhs.glGetBufferSubData;
//    glMapBuffer = rhs.glMapBuffer;
//    glUnmapBuffer = rhs.glUnmapBuffer;
//    glGetBufferParameteriv = rhs.glGetBufferParameteriv;
//    glGetBufferPointerv = rhs.glGetBufferPointerv;
//    glBindBufferRange = rhs.glBindBufferRange;
//    glBindBufferBase = rhs.glBindBufferBase;
//    glTexBuffer = rhs.glTexBuffer;
#endif 
...
//#else
//	if (!rhs.glGenBuffers) glGenBuffers = rhs.glGenBuffers;
//    if (!rhs.glBindBuffer) glBindBuffer = rhs.glBindBuffer;
//    if (!rhs.glBufferData) glBufferData = rhs.glBufferData;
//    if (!rhs.glBufferSubData) glBufferSubData = rhs.glBufferSubData;
//    if (!rhs.glDeleteBuffers) glDeleteBuffers = rhs.glDeleteBuffers;
//    if (!rhs.glIsBuffer) glIsBuffer = rhs.glIsBuffer;
//    if (!rhs.glGetBufferSubData) glGetBufferSubData = rhs.glGetBufferSubData;
//    if (!rhs.glMapBuffer) glMapBuffer = rhs.glMapBuffer;
//    if (!rhs.glUnmapBuffer) glUnmapBuffer = rhs.glUnmapBuffer;
//    if (!rhs.glGetBufferParameteriv) glGetBufferParameteriv = rhs.glGetBufferParameteriv;
//    if (!rhs.glGetBufferParameteriv) glGetBufferPointerv = rhs.glGetBufferPointerv;
//    if (!rhs.glBindBufferRange) glBindBufferRange = rhs.glBindBufferRange;
//    if (!rhs.glBindBufferBase) glBindBufferBase = rhs.glBindBufferBase;
//    if (!rhs.glTexBuffer) glTexBuffer = rhs.glTexBuffer;
#endif 
...
//    setGLExtensionFuncPtr(glBindBufferBase, "glBindBufferBase");
...
#else
void GLBufferObject::Extensions::_glGenBuffers(GLsizei n, GLuint *buffers) const
{
     glGenBuffers(n, buffers);
    
}

void GLBufferObject::Extensions::_glBindBuffer(GLenum target, GLuint buffer) const
{
#ifndef EMSCRIPTEN
...
void GLBufferObject::Extensions::_glBufferData(GLenum target, GLsizeiptrARB size, const GLvoid *data, GLenum usage) const
{
    glBufferData(target, size, data, usage);
    
}

void GLBufferObject::Extensions::_glBufferSubData(GLenum target, GLintptrARB offset, GLsizeiptrARB size, const GLvoid *data) const
{
    glBufferSubData(target, offset, size, data);
    
}

void GLBufferObject::Extensions::_glDeleteBuffers(GLsizei n, const GLuint *buffers) const
{
    glDeleteBuffers(n, buffers);
}

GLboolean GLBufferObject::Extensions::_glIsBuffer (GLuint buffer) const
{
    return glIsBuffer(buffer);
    
}

void GLBufferObject::Extensions::_glGetBufferSubData (GLenum target, GLintptrARB offset, GLsizeiptrARB size, GLvoid *data) const
{
#ifndef EMSCRIPTEN
...
GLvoid* GLBufferObject::Extensions::_glMapBuffer (GLenum target, GLenum access) const
{
#ifndef EMSCRIPTEN
...
GLboolean GLBufferObject::Extensions::_glUnmapBuffer (GLenum target) const
{
#ifndef EMSCRIPTEN
...
void GLBufferObject::Extensions::_glGetBufferParameteriv (GLenum target, GLenum pname, GLint *params) const
{
#ifndef EMSCRIPTEN
...
void GLBufferObject::Extensions::_glGetBufferPointerv (GLenum target, GLenum pname, GLvoid* *params) const
{
#ifndef EMSCRIPTEN
...
void GLBufferObject::Extensions::_glBindBufferRange (GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size)
{
#ifndef EMSCRIPTEN
    if (glBindBufferRange) glBindBufferRange(target, index, buffer, offset, size);
    else OSG_WARN<<"Error: glBindBufferRange not supported by OpenGL driver\n";
#endif
}

void GLBufferObject::Extensions::_glBindBufferBase (GLenum target, GLuint index, GLuint buffer)
{
#ifndef EMSCRIPTEN
    if (glBindBufferBase) glBindBufferBase(target, index, buffer);
    else OSG_WARN<<"Error: glBindBufferBase not supported by OpenGL driver\n";
#endif
}

void GLBufferObject::Extensions::_glTexBuffer( GLenum target, GLenum internalFormat, GLuint buffer ) const
{
#ifndef EMSCRIPTEN
    if ( glTexBuffer ) glTexBuffer( target, internalFormat, buffer );
    else OSG_WARN<<"Error: glTexBuffer not supported by OpenGL driver\n";
#endif
}
...
#else
	bo->_extensions->_glBindBuffer(_profile._target, bo->getGLObjectID());
    bo->_extensions->_glBufferData(_profile._target, _profile._size, NULL, _profile._usage);
    bo->_extensions->_glBindBuffer(_profile._target, 0);
#endif
}
...
#else
	bo->_extensions->_glBindBuffer(GL_PIXEL_UNPACK_BUFFER_ARB, bo->getGLObjectID());
#endif
...
#else
	bo->_extensions->_glBindBuffer(GL_PIXEL_PACK_BUFFER_ARB, bo->getGLObjectID());
#endif
...
void PixelDataBufferObject::unbindBuffer(unsigned int contextID) const
{
    ...
    switch(_mode[contextID])
    {
		...
		#else
			extensions->_glBindBuffer(GL_PIXEL_UNPACK_BUFFER_ARB,0);
		#endif
			break;
        case WRITE:
		#ifndef EMSCRIPTEN
			extensions->glBindBuffer(GL_PIXEL_UNPACK_BUFFER_ARB,0);
		#else
			extensions->_glBindBuffer(GL_PIXEL_PACK_BUFFER_ARB,0);
		#endif
		...
		#else
			extensions->_glBindBuffer(_profile._target,0);
		#endif
