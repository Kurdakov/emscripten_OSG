...
//#else
//	setGLExtensionFuncPtr(glClientActiveTexture,"glClientActiveTexture","glClientActiveTextureARB");
//    setGLExtensionFuncPtr(glActiveTexture, "glActiveTexture","glActiveTextureARB");
//    setGLExtensionFuncPtr(glFogCoordPointer, "glFogCoordPointer","glFogCoordPointerEXT");
//    setGLExtensionFuncPtr(glSecondaryColorPointer, "glSecondaryColorPointer","glSecondaryColorPointerEXT");
//    setGLExtensionFuncPtr(glVertexAttribPointer, "glVertexAttribPointer","glVertexAttribPointerARB");
//    setGLExtensionFuncPtr(glVertexAttribIPointer, "glVertexAttribIPointer");
//    setGLExtensionFuncPtr(glVertexAttribLPointer, "glVertexAttribLPointer","glVertexAttribPointerARB");
//    setGLExtensionFuncPtr(glEnableVertexAttribArray, "glEnableVertexAttribArray","glEnableVertexAttribArrayARB");
//    setGLExtensionFuncPtr(glMultiTexCoord4f, "glMultiTexCoord4f","glMultiTexCoord4fARB");
//    setGLExtensionFuncPtr(glVertexAttrib4f, "glVertexAttrib4f");
//    setGLExtensionFuncPtr(glVertexAttrib4fv, "glVertexAttrib4fv");
//    setGLExtensionFuncPtr(glDisableVertexAttribArray, "glDisableVertexAttribArray","glDisableVertexAttribArrayARB");
//    setGLExtensionFuncPtr(glBindBuffer, "glBindBuffer","glBindBufferARB");
//
//    setGLExtensionFuncPtr(glDrawArraysInstanced, "glDrawArraysInstanced","glDrawArraysInstancedARB","glDrawArraysInstancedEXT");
//    setGLExtensionFuncPtr(glDrawElementsInstanced, "glDrawElementsInstanced","glDrawElementsInstancedARB","glDrawElementsInstancedEXT");
#endif
...
#else
			extensions->_glGetQueryiv(GL_TIMESTAMP, GL_QUERY_COUNTER_BITS_ARB, &bits);
#endif
...
#else
		if (glClientActiveTexture && unit < (unsigned int)_glMaxTextureCoords)
#endif
        {
		#ifndef EMSCRIPTEN
...
#else
		extensions->_glGetInteger64v(GL_TIMESTAMP, &timestamp);
#endif
