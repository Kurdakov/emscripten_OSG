...
void FragmentProgram::flushDeletedFragmentProgramObjects(unsigned int contextID,double /*currentTime*/, double& availableTime)
{
...

    {
        ...
        {
            extensions->_glDeletePrograms( 1L, &(*titr ) );
...
#else
	_isFragmentProgramSupported = true;
...
#else
void FragmentProgram::Extensions::_glBindProgram(GLenum target, GLuint id) const
{
  
        glBindProgram(target,id);
  
}

void FragmentProgram::Extensions::_glGenPrograms(GLsizei n, GLuint *programs) const
{
   
        glGenPrograms(n,programs);
   
}

void FragmentProgram::Extensions::_glDeletePrograms(GLsizei n, GLuint *programs) const
{
   
       glDeletePrograms(n,programs);
   
}

void FragmentProgram::Extensions::_glProgramString(GLenum target, GLenum format, GLsizei len, const void *string) const
{
    
        glProgramString(target,format, len, string);
    
}

void FragmentProgram::Extensions::_glProgramLocalParameter4fv(GLenum target, GLuint index, const GLfloat *params) const
{
        glProgramLocalParameter4fv(target, index, params);
