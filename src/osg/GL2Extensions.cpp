...
#else
	//glAttachShader  = rhs.glAttachShader;
	//glCompileShader = rhs.glCompileShader;
	//glCreateShader  = rhs.glCreateShader;
	//glDeleteShader  = rhs.glDeleteShader;
	//glDetachShader  = rhs.glDetachShader;
	////getShaderInfoLog
	//glShaderSource       = rhs.glShaderSource;
	//glGetShaderiv        = rhs.glGetShaderiv;        
	//glGetProgramiv       = rhs.glGetProgramiv;    
	//glBindAttribLocation = rhs.glBindAttribLocation;
	//glCreateProgram      = rhs.glCreateProgram;     
	//glDeleteProgram      = rhs.glDeleteProgram;     
	//					 
	////getProgramInfoLog    =  rhs.getProgramInfoLog;
	//glBindFragDataLocation  = rhs.glBindFragDataLocation;
	//glProgramParameteri		= rhs.glProgramParameteri;		
	//glLinkProgram			= rhs.glLinkProgram;			
	//glUseProgram			= rhs.glUseProgram;			
	//glGetProgramBinary      = rhs.glGetProgramBinary;
	//glValidateProgram		    = rhs.glValidateProgram;		    
	//glGetProgramBinary          = rhs.glGetProgramBinary;          
	//glProgramBinary				= rhs.glProgramBinary;				
	//glDispatchCompute			= rhs.glDispatchCompute;			
	//glGetActiveUniformsiv		= rhs.glGetActiveUniformsiv;		
	//glGetActiveUniformBlockiv	= rhs.glGetActiveUniformBlockiv;	
	//glGetActiveUniformBlockName	= rhs.glGetActiveUniformBlockName;	
	//glUniformBlockBinding       = rhs.glUniformBlockBinding;         
	//glGetActiveUniform			= rhs.glGetActiveUniform;			
	//glGetUniformLocation		= rhs.glGetUniformLocation;		
	//glGetActiveAttrib			= rhs.glGetActiveAttrib;			
	//glGetAttribLocation			= rhs.glGetAttribLocation;			
	//glGetActiveAtomicCounterBufferiv = rhs.glGetActiveAtomicCounterBufferiv;
	//glUniform1uiv               = rhs.glUniform1uiv;                
	//glUniform2uiv				= rhs.glUniform2uiv;				
	//glUniform3uiv				= rhs.glUniform3uiv;				
	//glUniform4uiv				= rhs.glUniform4uiv;				
	//glUniformMatrix2x3fv		= rhs.glUniformMatrix2x3fv;		
	//glUniformMatrix3x2fv		= rhs.glUniformMatrix3x2fv;		
	//glUniformMatrix2x4fv        = rhs.glUniformMatrix2x4fv;        
	//glUniformMatrix4x2fv		= rhs.glUniformMatrix4x2fv;		
	//glUniformMatrix3x4fv		= rhs.glUniformMatrix3x4fv;		
	//glUniformMatrix4x3fv		= rhs.glUniformMatrix4x3fv;		
	//glUniform1fv				= rhs.glUniform1fv;				
	//glUniform2fv				= rhs.glUniform2fv;				
	//glUniform3fv                = rhs.glUniform3fv;                 
	//glUniform4fv              	= rhs.glUniform4fv;              	
	//glUniform1iv				= rhs.glUniform1iv;				
	//glUniform2iv				= rhs.glUniform2iv;				
	//glUniform3iv				= rhs.glUniform3iv;				
	//glUniform4iv				= rhs.glUniform4iv;				
	//glUniformMatrix2fv			= rhs.glUniformMatrix2fv;			 
	//glUniformMatrix3fv			= rhs.glUniformMatrix3fv;			
	//glUniformMatrix4fv			= rhs.glUniformMatrix4fv;			
	//glUniform1dv				= rhs.glUniform1dv;				
	//glUniform2dv				= rhs.glUniform2dv;				
	//glUniform3dv				= rhs.glUniform3dv;				
	//glUniform4dv				= rhs.glUniform4dv;				 
	//glUniformMatrix2dv			= rhs.glUniformMatrix2dv;			
	//glUniformMatrix3dv			= rhs.glUniformMatrix3dv;			
	//glUniformMatrix4dv			= rhs.glUniformMatrix4dv;			
	//glUniformMatrix2x3dv		= rhs.glUniformMatrix2x3dv;		
	//glUniformMatrix3x2dv		= rhs.glUniformMatrix3x2dv;		
	//glUniformMatrix2x4dv		= rhs.glUniformMatrix2x4dv;		
	//glUniformMatrix4x2dv		= rhs.glUniformMatrix4x2dv;		
	//glUniformMatrix3x4dv		= rhs.glUniformMatrix3x4dv;	
	//glUniformMatrix4x3dv		= rhs.glUniformMatrix4x3dv;		
	//glDrawBuffers				= rhs.glDrawBuffers;				
#endif
}
...
#else
void GL2Extensions::_glAttachShader(GLuint program, GLuint shader) const
{
   
        glAttachShader(program, shader);
}

void GL2Extensions::_glCompileShader(GLuint shader) const
{
        glCompileShader(shader);
}

GLuint GL2Extensions::_glCreateShader(GLenum type) const
{
        return glCreateShader(type);
}

void GL2Extensions::_glDeleteShader(GLuint shader) const
{
         glDeleteShader(shader);
 }

void GL2Extensions::_glDetachShader(GLuint program, GLuint shader) const
{
        glDetachShader(program, shader);
}

void GL2Extensions::_glGetShaderInfoLog(GLuint shader, GLsizei bufSize, GLsizei *length, GLchar *infoLog) const
{
        glGetShaderInfoLog(shader, bufSize, length, infoLog);

}
bool GL2Extensions::_getShaderInfoLog( GLuint shader, std::string& result ) const
{
    GLsizei bufLen = 0;        // length of buffer to allocate
    GLsizei strLen = 0;        // strlen GL actually wrote to buffer
    ...
    {
        GLchar* infoLog = new GLchar[bufLen];
        _glGetShaderInfoLog( shader, bufLen, &strLen, infoLog );
        if( strLen > 0 ) result = reinterpret_cast<char*>(infoLog);
        delete [] infoLog;
    }
    return (strLen > 0);
}
void GL2Extensions::_glShaderSource(GLuint shader, GLsizei count, const GLchar* *string, const GLint *length) const
{
        glShaderSource(shader, count, string, length);
}

void GL2Extensions::_glGetShaderiv(GLuint shader, GLenum pname, GLint *params) const
{
        glGetShaderiv(shader, pname, params);
}

void GL2Extensions::_glGetProgramiv(GLuint program, GLenum pname, GLint *params) const
{
       glGetProgramiv(program, pname, params);
}

void GL2Extensions::_glBindAttribLocation(GLuint program, GLuint index, const GLchar *name) const
{
...
GLuint GL2Extensions::_glCreateProgram(void) const
{
        return glCreateProgram();

}

void GL2Extensions::_glDeleteProgram(GLuint program) const
{
...
bool GL2Extensions::_getProgramInfoLog( GLuint program, std::string& result ) const
{
    GLsizei bufLen = 0;        // length of buffer to allocate
    GLsizei strLen = 0;        // strlen GL actually wrote to buffer
...
void GL2Extensions::_glBindFragDataLocation( GLuint program, GLuint color, const GLchar* name ) const
{
        //glBindFragDataLocation( program, color, name );
	printf("glBindFragDataLoaction is not supported \n");

}

void GL2Extensions::_glLinkProgram(GLuint program) const
{
        glLinkProgram(program);

}

void GL2Extensions::_glProgramParameteri( GLuint program, GLenum pname, GLint value ) const
{

        //glProgramParameteri( program, pname, value );
	printf("glProgramParameteri is not supported \n");

}

void GL2Extensions::_glUseProgram(GLuint program) const
{
...
void GL2Extensions::_glValidateProgram(GLuint program) const
{
...
//ARB_get_program_binary
void GL2Extensions::_glGetProgramBinary(GLuint program,
                                       GLsizei bufSize,
                                       GLsizei *length,
                                       GLenum *binaryFormat,
                                       GLvoid *binary) const
{
		...
		printf("glGetProgramBinary is not supported \n");

}

void GL2Extensions::_glProgramBinary(GLuint program,
                                    GLenum binaryFormat,
                                    const GLvoid *binary,
                                    GLsizei length) const
{
    //glProgramBinary(program, binaryFormat, binary, length);
	printf("glProgramBinary is not supported \n");
    
}

void GL2Extensions::_glDispatchCompute( GLuint numGroupsX, GLuint numGroupsY, GLuint numGroupsZ ) const
{
...
void GL2Extensions::_glGetActiveUniformsiv(GLuint program, GLsizei uniformCount,
                                          const GLuint *uniformIndices,
                                          GLenum pname, GLint *params) const
{
        ...
        //glGetActiveUniformsiv(program, uniformCount, uniformIndices, pname,
         //                      params);
	printf("glGetActiveUniformsiv is not supported \n");

        //NotSupported("glGetActiveUniformsiv");

}

void GL2Extensions::_glGetActiveUniformBlockiv(GLuint program,
                                              GLuint uniformBlockIndex,
                                              GLenum pname, GLint *params) const
{
   
        //glGetActiveUniformBlockiv(program, uniformBlockIndex, pname, params);
		printf("glGetActiveUniformBlockiv is not supported \n");
        //NotSupported("glGetActiveUniformBlockiv");
    
}

void GL2Extensions::_glGetActiveUniformBlockName(GLuint program,
                                                GLuint uniformBlockIndex,
                                                GLsizei bufSize,
                                                GLsizei *length,
                                                GLchar *uniformBlockName) const
{
        ...
        //                            length, uniformBlockName);
		printf("glGetActiveUniformBlockName is not supported \n");
        //NotSupported("glGetActiveUniformBlockName");
}

void GL2Extensions::_glUniformBlockBinding(GLuint program,
                                          GLuint uniformBlockIndex,
                                          GLuint uniformBlockBinding) const
{

        //glUniformBlockBinding(program, uniformBlockIndex, uniformBlockBinding);
		printf("glUniformBlockBinding is not supported \n");
        //NotSupported("glUniformBlockBinding");

}

void GL2Extensions::_glGetActiveAttrib(GLuint program, GLuint index, GLsizei bufSize, GLsizei *length, GLint *size, GLenum *type, GLchar *name) const
{
...
void GL2Extensions::_glGetActiveUniform(GLuint program, GLuint index, GLsizei bufSize, GLsizei *length, GLint *size, GLenum *type, GLchar *name) const
{
...
GLint GL2Extensions::_glGetUniformLocation(GLuint program, const GLchar *name) const
{
...
GLint GL2Extensions::_glGetAttribLocation(GLuint program, const GLchar *name) const
{
...
void GL2Extensions::_glUniform1ui( GLint location, GLuint v0 ) const
{
...
void GL2Extensions::_glUniform2ui( GLint location, GLuint v0, GLuint v1 ) const
{
...
void GL2Extensions::_glUniform3ui( GLint location, GLuint v0, GLuint v1, GLuint v2 ) const
{
...
void GL2Extensions::_glUniform4ui( GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3 ) const
{
...
void GL2Extensions::_glUniform1uiv( GLint location, GLsizei count, const GLuint *value ) const
{
...
void GL2Extensions::_glUniform2uiv( GLint location, GLsizei count, const GLuint *value ) const
{
...
void GL2Extensions::_glUniform3uiv( GLint location, GLsizei count, const GLuint *value ) const
{
...
void GL2Extensions::_glUniform4uiv( GLint location, GLsizei count, const GLuint *value ) const
{
...
void GL2Extensions::_glGetActiveAtomicCounterBufferiv( GLuint program, GLuint bufferIndex, GLenum pname, GLint* params ) const
{
...
void GL2Extensions::_glUniformMatrix2x3fv( GLint location, GLsizei count, GLboolean transpose, const GLfloat* value ) const
{
...
void GL2Extensions::_glUniformMatrix3x2fv( GLint location, GLsizei count, GLboolean transpose, const GLfloat* value ) const
{
...
void GL2Extensions::_glUniformMatrix2x4fv( GLint location, GLsizei count, GLboolean transpose, const GLfloat* value ) const
{
...
void GL2Extensions::_glUniformMatrix4x2fv( GLint location, GLsizei count, GLboolean transpose, const GLfloat* value ) const
{
...
void GL2Extensions::_glUniformMatrix3x4fv( GLint location, GLsizei count, GLboolean transpose, const GLfloat* value ) const
{
...
void GL2Extensions::_glUniformMatrix4x3fv( GLint location, GLsizei count, GLboolean transpose, const GLfloat* value ) const
{
...
void GL2Extensions::_glUniform1fv(GLint location, GLsizei count, const GLfloat *value) const
{
...
void GL2Extensions::_glUniform2fv(GLint location, GLsizei count, const GLfloat *value) const
{
...
void GL2Extensions::_glUniform3fv(GLint location, GLsizei count, const GLfloat *value) const
{
...
void GL2Extensions::_glUniform4fv(GLint location, GLsizei count, const GLfloat *value) const
{
...
void GL2Extensions::_glUniform1iv(GLint location, GLsizei count, const GLint *value) const
{
...
void GL2Extensions::_glUniform2iv(GLint location, GLsizei count, const GLint *value) const
{
...
void GL2Extensions::_glUniform3iv(GLint location, GLsizei count, const GLint *value) const
{
...
void GL2Extensions::_glUniform4iv(GLint location, GLsizei count, const GLint *value) const
{
...
void GL2Extensions::_glUniformMatrix2fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
...
void GL2Extensions::_glUniformMatrix3fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
...
void GL2Extensions::_glUniformMatrix4fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value) const
{
...
void GL2Extensions::_glUniform1dv(GLint location, GLsizei count, const GLdouble *value) const
{
...
void GL2Extensions::_glUniform2dv(GLint location, GLsizei count, const GLdouble *value) const
{
...
void GL2Extensions::_glUniform3dv(GLint location, GLsizei count, const GLdouble *value) const
{
...
void GL2Extensions::_glUniform4dv(GLint location, GLsizei count, const GLdouble *value) const
{
...
void GL2Extensions::_glUniformMatrix2dv(GLint location, GLsizei count, GLboolean transpose, const GLdouble *value) const
{
...
void GL2Extensions::_glUniformMatrix3dv(GLint location, GLsizei count, GLboolean transpose, const GLdouble *value) const
{
...
void GL2Extensions::_glUniformMatrix4dv(GLint location, GLsizei count, GLboolean transpose, const GLdouble *value) const
{
...
void GL2Extensions::_glUniformMatrix2x3dv( GLint location, GLsizei count, GLboolean transpose, const GLdouble* value ) const
{
...
void GL2Extensions::_glUniformMatrix3x2dv( GLint location, GLsizei count, GLboolean transpose, const GLdouble* value ) const
{
...
void GL2Extensions::_glUniformMatrix2x4dv( GLint location, GLsizei count, GLboolean transpose, const GLdouble* value ) const
{
...
void GL2Extensions::_glUniformMatrix4x2dv( GLint location, GLsizei count, GLboolean transpose, const GLdouble* value ) const
{
...
void GL2Extensions::_glUniformMatrix3x4dv( GLint location, GLsizei count, GLboolean transpose, const GLdouble* value ) const
{
...
void GL2Extensions::_glUniformMatrix4x3dv( GLint location, GLsizei count, GLboolean transpose, const GLdouble* value ) const
{
...
void GL2Extensions::_glDrawBuffers(GLsizei n, const GLenum *bufs) const
{
