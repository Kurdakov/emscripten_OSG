...
#else
	if (_numInstances>=1) state._glDrawArraysInstanced(mode,_first,_count, _numInstances);
#endif
...
void DrawElementsUByte::draw(State& state, bool useVertexBufferObjects) const
{
    ...
    if (useVertexBufferObjects)
    {
        ...
        if (ebo)
        {
			...
			#else
			if (_numInstances>=1) state._glDrawElementsInstanced(mode, size(), GL_UNSIGNED_BYTE, (const GLvoid *)(ebo->getOffset(getBufferIndex())), _numInstances);
			#endif
        ...
        else
        {
			...
			#else
			if (_numInstances>=1) state._glDrawElementsInstanced(mode, size(), GL_UNSIGNED_BYTE, &front(), _numInstances);
			#endif
...
void DrawElementsUShort::draw(State& state, bool useVertexBufferObjects) const
{
    ...
    if (useVertexBufferObjects)
    {
        ...
        if (ebo)
        {
			...
			#else
			if (_numInstances>=1) state._glDrawElementsInstanced(mode, size(), GL_UNSIGNED_SHORT, (const GLvoid *)(ebo->getOffset(getBufferIndex())), _numInstances);
			#endif
        ...
        else
        {
			...
			#else
			if (_numInstances>=1) state._glDrawElementsInstanced(mode, size(), GL_UNSIGNED_SHORT, &front(), _numInstances);
			#endif
...
void DrawElementsUInt::draw(State& state, bool useVertexBufferObjects) const
{
    ...
    if (useVertexBufferObjects)
    {
        ...
        if (ebo)
        {
			...
			#else
			if (_numInstances>=1) state._glDrawElementsInstanced(mode, size(), GL_UNSIGNED_INT, (const GLvoid *)(ebo->getOffset(getBufferIndex())), _numInstances);
			#endif
        ...
        else
        {
			...
			#else
			if (_numInstances>=1) state._glDrawElementsInstanced(mode, size(), GL_UNSIGNED_INT, &front(), _numInstances);
			#endif
