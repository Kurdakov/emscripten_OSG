...
#else
void VertexProgram::Extensions::_glBindProgram(GLenum target, GLuint id) const
{
...
void VertexProgram::Extensions::_glGenPrograms(GLsizei n, GLuint *programs) const
{
...
void VertexProgram::Extensions::_glDeletePrograms(GLsizei n, GLuint *programs) const
{
    
    
}

void VertexProgram::Extensions::_glProgramString(GLenum target, GLenum format, GLsizei len, const void *string) const
{
...
void VertexProgram::Extensions::_glProgramLocalParameter4fv(GLenum target, GLuint index, const GLfloat *params) const
{
