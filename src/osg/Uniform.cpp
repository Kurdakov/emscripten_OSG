...
void Uniform::apply(const GL2Extensions* ext, GLint location) const
{
...
#else
		if( _floatArray.valid() ) ext->_glUniform1fv( location, num, &_floatArray->front() );
#endif
        break;
...
#else
		if( _floatArray.valid() ) ext->_glUniform2fv( location, num, &_floatArray->front() );
#endif
        break;
...
#else
		if( _floatArray.valid() ) ext->_glUniform3fv( location, num, &_floatArray->front() );
#endif
        break;
    ...
    case FLOAT_VEC4:
        ...
        if( _floatArray.valid() ) ext->glUniform3fv( location, num, &_floatArray->front() );
#else
		if( _floatArray.valid() ) ext->_glUniform4fv( location, num, &_floatArray->front() );
#endif
        break;
...
#else
		if( _floatArray.valid() ) ext->_glUniformMatrix2fv( location, num, GL_FALSE, &_floatArray->front() );
#endif
        break;
...
#else
		if( _floatArray.valid() ) ext->_glUniformMatrix3fv( location, num, GL_FALSE, &_floatArray->front() );
#endif
        break;
...
#else
		if( _floatArray.valid() ) ext->_glUniformMatrix4fv( location, num, GL_FALSE, &_floatArray->front() );
#endif
        break;
...
#else
		if( _floatArray.valid() ) ext->_glUniformMatrix2x3fv( location, num, GL_FALSE, &_floatArray->front() );
#endif
        break;
...
#else
		if( _floatArray.valid() ) ext->_glUniformMatrix2x4fv( location, num, GL_FALSE, &_floatArray->front() );
#endif
        break;
...
#else
		if( _floatArray.valid() ) ext->_glUniformMatrix3x2fv( location, num, GL_FALSE, &_floatArray->front() );
#endif
        break;
...
#else
		if( _floatArray.valid() ) ext->_glUniformMatrix3x4fv( location, num, GL_FALSE, &_floatArray->front() );
#endif
        break;
...
#else
		if( _floatArray.valid() ) ext->_glUniformMatrix4x2fv( location, num, GL_FALSE, &_floatArray->front() );
#endif
        break;
...
#else
		if( _floatArray.valid() ) ext->_glUniformMatrix4x3fv( location, num, GL_FALSE, &_floatArray->front() );
#endif
        break;
...
#else
		if( _doubleArray.valid() ) ext->_glUniform1dv( location, num, &_doubleArray->front() );
#endif
        break;
...
#else
		if( _doubleArray.valid() ) ext->_glUniform2dv( location, num, &_doubleArray->front() );
#endif
        break;
...
#else
		if( _doubleArray.valid() ) ext->_glUniform3dv( location, num, &_doubleArray->front() );
#endif
        break;
...
#else
		if( _doubleArray.valid() ) ext->_glUniform4dv( location, num, &_doubleArray->front() );
#endif
        break;
...
#else
		if( _doubleArray.valid() ) ext->_glUniformMatrix2dv( location, num, GL_FALSE, &_doubleArray->front() );
#endif
        break;
...
#else
		if( _doubleArray.valid() ) ext->_glUniformMatrix3dv( location, num, GL_FALSE, &_doubleArray->front() );
#endif
        break;
...
#else
		if( _doubleArray.valid() ) ext->_glUniformMatrix4dv( location, num, GL_FALSE, &_doubleArray->front() );
#endif
        break;
...
#else
		if( _doubleArray.valid() ) ext->_glUniformMatrix2x3dv( location, num, GL_FALSE, &_doubleArray->front() );
#endif
        break;
...
#else
		if( _doubleArray.valid() ) ext->_glUniformMatrix2x4dv( location, num, GL_FALSE, &_doubleArray->front() );
#endif
        break;
...
#else
		if( _doubleArray.valid() ) ext->_glUniformMatrix3x2dv( location, num, GL_FALSE, &_doubleArray->front() );
#endif
        break;
...
#else
		if( _doubleArray.valid() ) ext->_glUniformMatrix3x4dv( location, num, GL_FALSE, &_doubleArray->front() );
#endif
        break;
...
#else
		if( _doubleArray.valid() ) ext->_glUniformMatrix4x2dv( location, num, GL_FALSE, &_doubleArray->front() );
#endif
        break;
...
#else
		if( _doubleArray.valid() ) ext->_glUniformMatrix4x3dv( location, num, GL_FALSE, &_doubleArray->front() );
#endif
        break;
...
#else
		if( _intArray.valid() ) ext->_glUniform1iv( location, num, &_intArray->front() );
#endif
        break;
...
#else
		if( _intArray.valid() ) ext->_glUniform2iv( location, num, &_intArray->front() );
#endif
        break;
...
#else
		if( _intArray.valid() ) ext->_glUniform3iv( location, num, &_intArray->front() );
#endif
        break;
...
#else
		if( _intArray.valid() ) ext->_glUniform4iv( location, num, &_intArray->front() );
#endif
        break;
...
#else
		if( _uintArray.valid() ) ext->_glUniform1uiv( location, num, &_uintArray->front() );
#endif
        break;
...
#else
		if( _uintArray.valid() ) ext->_glUniform2uiv( location, num, &_uintArray->front() );
#endif
        break;
...
#else
		if( _uintArray.valid() ) ext->_glUniform3uiv( location, num, &_uintArray->front() );
#endif
        break;
...
#else
		if( _uintArray.valid() ) ext->_glUniform4uiv( location, num, &_uintArray->front() );
#endif
        break;
