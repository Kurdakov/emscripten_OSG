...
bool StatsHandler::handle(const osgGA::GUIEventAdapter& ea, osgGA::GUIActionAdapter& aa)
{
    ...
    if (viewer /* && _threadingModelText.valid() SKur */&& viewer->getThreadingModel()!=_threadingModel)
    {
...
struct CameraSceneStatsTextDrawCallback : public virtual osg::Drawable::DrawCallback
{
    ...
    virtual void drawImplementation(osg::RenderInfo& renderInfo,const osg::Drawable* drawable) const
    {
      ...
      //SKur  osgText::Text* text = (osgText::Text*)drawable;
        ...
        if (delta > 100) // update every 100ms
        {
            ...
            if (stats && renderer)
            {
             ...
             //SKur   text->setText(viewStr.str());
            }
        }
        //SKur text->drawImplementation(renderInfo);
    }
...
//                    double multiplier):
//        _dp(dp)//,
//      //SKur  _minValue(minValue),
//      //SKur  _maxValue(maxValue),
//       //SKur _averageValue(averageValue),
//      //SKur  _filerequestlist(filerequestlist),
//     //SKur   _compilelist(compilelist),
//      //SKur  _multiplier(multiplier)
//    {
//    }
//
...
//               //SKur _averageValue->setText(tmpText);
//            }
//            else
//            {
//               //SKur _averageValue->setText("");
//            }
//
...
//            {
//                sprintf(tmpText,"%4.0f",value * _multiplier);
//               //SKur _minValue->setText(tmpText);
//            }
//            else
//            {
//               //SKur _minValue->setText("");
//            }
//
...
//            {
//                sprintf(tmpText,"%4.0f",value * _multiplier);
//               //SKur _maxValue->setText(tmpText);
//            }
//            else
//            {
//              //SKur  _maxValue->setText("");
//            }
//
//            sprintf(tmpText,"%4d", _dp->getFileRequestListSize());
//           //SKur _filerequestlist->setText(tmpText);
//
//            sprintf(tmpText,"%4d", _dp->getDataToCompileListSize());
//            //SKur _compilelist->setText(tmpText);
//        }
//
//        traverse(node,nv);
//    }
...
//
//   //SKur osg::ref_ptr<osgText::Text> _minValue;
...
void StatsHandler::setUpScene(osgViewer::ViewerBase* viewer)
{
    ...
    // viewer stats
    {
      ...
      //SKur      _threadingModelText = new osgText::Text;
       //SKur     _statsGeode->addDrawable( _threadingModelText.get() );

        //SKur    _threadingModelText->setColor(colorFR);
       ///SKur/SKur     _threadingModelText->setFont(_font);
       //SKur     _threadingModelText->setCharacterSize(_characterSize);
       //SKur     _threadingModelText->setPosition(pos);

      //SKur      updateThreadingModelText();
            ...
            ++itr)
        {
            ...
            if (dp && dp->isRunning())
            {
             ...
             ////SKur   osg::ref_ptr<osgText::Text> averageLabel = new osgText::Text;
            ...
            //SKur    osg::ref_ptr<osgText::Text> compileList = new osgText::Text;
          ...
          //      compileList->setCharacterSize(_characterSize);
           ...
           //     compileList->setText("0");
            ...
            //    pos.x() = maxLabel->getBound().xMax();
              ...
              //SKur  _statsGeode->setCullCallback(new PagerCallback(dp, minValue.get(), maxValue.get(), averageValue.get(), requestList.get(), compileList.get(), 1000.0));
            }
